...
const row1Assets = [
  { title: 'Aim High World Finals 국제 스트릿 댄스 배틀', src: '/03_portfolio/global/1591241549941.jpg' },
  { title: '글로벌 아티스트 초청 및 마스터 클래스 워크숍', src: '/03_portfolio/global/1591241595359.jpg' },
  { title: '세계 무대 출전 지도자 선발 파이널 무대', src: '/03_portfolio/global/1591241600534.jpg' },
  { title: 'Aim High World Finals 챔피언십 시상식', src: '/03_portfolio/global/1591244732690.jpg' },
  { title: '벨리 댄스 국제 부문 그랑프리 경연 현장', src: '/03_portfolio/global/1592998449624.jpg' },
  { title: 'Aim High World Finals 갈라쇼 현장', src: '/03_portfolio/global/1592998480670.jpg' },
  { title: '전세계 20개국 참가 지도사 아카이빙 세션', src: '/03_portfolio/global/1592998653888.jpg' },
  { title: '글로벌 청소년 댄스 루키 인터내셔널 매치', src: '/03_portfolio/global/1592998678795.jpg' }
];

const row2Assets = [
  { title: '국제 스트릿 댄스 지도사 심사위원단 워크숍', src: '/03_portfolio/global/1592998693647.jpg' },
  { title: 'Aim High World Finals 백스테이지 아티스트 세션', src: '/03_portfolio/global/1592998696248.jpg' },
  { title: '국제 대회 무대 기획 및 연출 디렉션', src: '/03_portfolio/global/1592998921623.jpg' },
  { title: '글로벌 챔피언십 결선 무대 하이라이트', src: '/03_portfolio/global/1592998971935.jpg' },
  { title: 'Aim High World Finals 메인 오프닝 퍼포먼스', src: '/03_portfolio/global/1592999873619.jpg' },
  { title: '국제 벨리댄스 라이징 스타 그랑프리 무대', src: '/03_portfolio/global/1593000006434.jpg' },
  { title: '글로벌 지도사 연합 시그니처 갈라 쇼', src: '/03_portfolio/global/1593000017662.jpg' },
  { title: 'Aim High World Finals 시상 및 메달 수여식', src: '/03_portfolio/global/1593000031670.jpg' }
];

const row3Assets = [
  { title: '글로벌 댄스 배틀 챔피언십 파이널 듀엣 경연', src: '/03_portfolio/global/1593000035541.jpg' },
  { title: '국제 대표 심사위원단 공식 기념 촬영', src: '/03_portfolio/global/1593000166839.jpg' },
  { title: 'Aim High World Finals 주니어 인터내셔널 매치', src: '/03_portfolio/global/1593000169670.jpg' },
  { title: '전세계 지도자 교류 웰컴 레셉션 파티', src: '/03_portfolio/global/1593000172625.jpg' },
  { title: '글로벌 아티스트 무대 퍼포먼스 클라이맥스', src: '/03_portfolio/global/1593000179988.jpg' },
  { title: 'Aim High World Finals 크루 배틀 파이널전', src: '/03_portfolio/global/1593000182900.jpg' },
  { title: '국제 대회 공로상 및 트로피 수여식 현장', src: '/03_portfolio/global/1593000189497.jpg' },
  { title: 'Aim High World Finals 엔딩 하모니 콘서트', src: '/03_portfolio/global/1593000214539.jpg' },
  { title: '글로벌 아티스트 아카이빙 세션', src: '/03_portfolio/global/kakaostory_2023_05_09_14_40_09.jpg' },
  { title: '글로벌 스트릿 댄스 지도사 네트워킹 아카이브', src: '/03_portfolio/global/1593000233349.jpg' }
];

// 2. Regional & Category Competition Assets
const regionalRow1Assets = [
  { title: '전국 50개 지부 통합 지도사 영재 발굴전', src: '/03_portfolio/regional/1529930870314.jpg' },
  { title: '대한민국 대표 지도자 시그니처 루틴 경연', src: '/03_portfolio/regional/1591241561056.jpg' },
  { title: 'Aim High Korea 지역 예선 챔피언십', src: '/03_portfolio/regional/1592997986362.jpg' },
  { title: '실용무용 및 에어로빅스 지도사 실기 검증전', src: '/03_portfolio/regional/1741565553400-29.jpg' },
  { title: '전국 주니어 댄스 아티스트 챔피언십 무대', src: '/03_portfolio/regional/1771916297494.jpg' },
  { title: '지역 지부 연계 예술 체육 네트워크 기획', src: '/03_portfolio/regional/1776900947932.jpg' },
  { title: 'NMAC 남양주 밸리댄스 대회 메인 갈라쇼', src: '/03_portfolio/regional/20170610_220944.jpg' }
];

const regionalRow2Assets = [
  { title: 'NMAC 밸리댄스 전국 선수권 대회 현장', src: '/03_portfolio/regional/20170611_123928.jpg' },
  { title: 'Aim High Korea 지역 지부 시상 및 파티', src: '/03_portfolio/regional/AV3U6591.jpg' },
  { title: 'NMAC 유소년 밸리댄스 영재 부문 시상식', src: '/03_portfolio/regional/AV3U6725.jpg' },
  { title: '지역 대표 지도자 연합 갈라 퍼포먼스', src: '/03_portfolio/regional/AV3U6798.jpg' },
  { title: 'NMAC 챔피언십 그랑프리 시상 현장', src: '/03_portfolio/regional/AV3U6801.jpg' },
  { title: '전국 지부 대표 지도자 하모니 콘서트', src: '/03_portfolio/regional/1777736336268.jpg' },
  { title: 'Aim High Korea 시상 및 성과 보고 파티', src: '/03_portfolio/regional/1776903492671.jpg' }
];

const regionalRow3Assets = [
  { title: 'NMAC 전국 밸리댄스 경연 대회 듀엣 부문', src: '/03_portfolio/regional/1771916298941.jpg' },
  { title: '지역 예술 체육 네트워킹 아카이빙 세션', src: '/03_portfolio/regional/1771916299463.jpg' },
  { title: 'Aim High Korea 주니어 댄스 파이널 시상', src: '/03_portfolio/regional/B612_20190623_115826_650.jpg' },
  { title: 'NMAC 밸리댄스 페스티벌 오프닝 무대', src: '/03_portfolio/regional/B612_20210515_201045_658.jpg' },
  { title: '카카오스토리 아카이브 밸리댄스 대회 현장', src: '/03_portfolio/regional/kakaostory_20220223_175421.jpg' },
  { title: '전국 밸리댄스 참가 선수단 단체 기념 촬영', src: '/03_portfolio/regional/kakaostory_20220223_175429.jpg' },
  { title: 'NMAC 지도자 포럼 및 성과 파티 세션', src: '/03_portfolio/regional/kakaostory_20220314_201204.jpg' }
];

// 3. Certification Archive Assets
const certRow1Assets = [
  { title: '대한민국 주무부처 정식 등록 지도자 자격 검증서', src: '/01_about/license.jpg' },
  { title: 'IICA 사단법인 인가 공식 CERTIFIED 마크', src: '/01_about/certified.png' },
  { title: '글로벌 표준 지도자 자격 검증 실적 아카이브', src: '/01_about/cert_3048.jpg' },
  { title: '국제 대표 지도자 공인 인증 배지', src: '/01_about/certified_badge.png' },
  { title: '대한민국 주무부처 정식 등록 지도자 자격 검증서', src: '/01_about/license.jpg' }
];
